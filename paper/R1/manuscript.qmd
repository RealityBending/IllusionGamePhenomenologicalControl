...
#| out-width: "100%"
#| fig-cap: "The parametric framework for visual illusions (Makowski et al., 2021) applied to the Müller-Lyer illusion (above). Below are examples of stimuli showcasing the manipulation of two parameters, task difficulty and illusion strength."

knitr::include_graphics("img/example_stimuli.png")
```
