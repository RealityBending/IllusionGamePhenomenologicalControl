...
The initial sample consisted of The initial sample consisted of 496 participants (Mean age = 38.5, SD = 13.1, range: [18, 73]; Gender: 49.6% women, 49.6% men, 0.81% non-binary; Education: Bachelor, 49.40%; Doctorate, 2.82%; Elementary school, 0.20%; High school, 27.62%; Master, 18.15%; Other, 1.81%), for a total trial number of 238080.

To ensure data quality, the registered protocol included three attention checks within the phenomenological control scale task. However, one of these checks  (i.e., instructing participants to press the space bar six times) led to the exclusion of 176 participants (36.74%), which was disproportionately high relative to the other two attention checks (17 participants; 3.55% combined).  Notably, only 7 participants failed more than one attention check, suggesting that the spacebar task may not have been a valid indicator of inattention. Accordingly, we deviated from the preregistered analysis by excluding this attention check from the final exclusion criteria. 

For the Illusion Game, preregistered performance-based and RT exclusion criteria were applied to identify participants responding at chance level and those exhibiting atypically slow response patterns. Furthermore, participants with mean RTs exceeding 4 standard deviations above the group mean were excluded, as this may reflect atypical task strategies. Based on the preregistered criteria, 17 participants were fully excluded and 16 participants had their second block removed. 

In addition to the preregistered protocol, trial-level exclusions were introduced to remove extreme response times [< 0.2 s or > 5 s; @theriault2024]. At the trial level, extreme RTs were removed (n = 739; 0.33% of trials) to minimise the influence of implausibly fast or slow responses.

Additionally, given HDI...

The final sample therefore comprised 460 participants (M_age = 38.7, SD = 13.1, range = 18–73). The sample was 48.5% women, 50.7% men, and 0.87% non-binary. Educational attainment was distributed as follows: Bachelor’s degree (48.26%), Master’s degree (18.26%), Doctorate (2.61%), high school (28.70%), elementary school (0.22%), and other (1.96%).

## Manipulation checks

Bayesian paired-samples t-test revealed extreme evidence for differences between Congruent and Mild conditions, as well between Mild and Strong conditions, across all illusion types and both outcomes (all BF₁₀s > 10⁸²). Overall, performance systematically decreased as illusion strength increased across all illusion types and outcome measures. 

For the Ebbinghaus illusion, there was strong evidence for lower Error Rates and IES in the Congruent relative to Mild condition (Error Rate: median difference = −0.12, BF₁₀ = 4.19 × 10¹¹⁷; IES: median difference = −0.22, BF₁₀ = 8.52 × 10⁸⁴), as well as lower performance in the Mild relative to Strong condition (Error Rate: median difference = −0.24, BF₁₀ = 3.87 × 10¹⁶⁸; IES: median difference = −0.58, BF₁₀ = 3.82 × 10⁸²).

For the Müller-Lyer illusion, results showed similarly extreme evidence for condition differences, with lower scores in Congruent relative to Mild (Error Rate: median difference = −0.24, BF₁₀ = 2.08 × 10²⁴⁴; IES: median difference = −0.44, BF₁₀ = 4.16 × 10²⁰⁴), and in Mild relative to Strong (Error Rate: median difference = −0.37, BF₁₀ = 9.12 × 10²⁷⁸; IES: median difference = −1.60, BF₁₀ = 1.83 × 10¹⁵⁰).

For the Vertical–Horizontal illusion, there was again extreme evidence for differences between conditions, with lower Error Rates and IES in Congruent relative to Mild (Error Rate: median difference = −0.16, BF₁₀ = 4.97 × 10¹³⁵; IES: median difference = −0.34, BF₁₀ = 3.05 × 10¹⁴⁶), and in Mild relative to Strong (Error Rate: median difference = −0.33, BF₁₀ = 1.36 × 10²¹⁰; IES: median difference = −1.18, BF₁₀ = 1.34 × 10¹⁰⁰).

Bayesian correlations were conducted to assess the relationship between performance in the Mild and Strong illusion conditions, separately by illusion type, difficulty level (Easy, Hard), and outcome (Error Rate, IES). All correlations were positive and statistically significant (ps < .001), indicating consistent individual differences across illusion strength. However, not all correlations met the preregistered threshold for collapsing conditions (r > .50).

For Error Rate, correlations exceeded the threshold for the Ebbinghaus (Easy: r = .52, 95% CI [.45, .58]; Hard: r = .63, 95% CI [.57, .68]) and Vertical–Horizontal illusions (Easy: r = .64, 95% CI [.58, .69]; Hard: r = .58, 95% CI [.52, .64]). In contrast, correlations for the Müller–Lyer illusion were below the threshold (Easy: r = .41, 95% CI [.33, .48]; Hard: r = .48, 95% CI [.41, .55]).

For IES, fewer correlations met the threshold. Only the Ebbinghaus illusion in both conditions (Easy: r = .59, 95% CI [.52, .64]; Hard: r = .56, 95% CI [.49, .62]) and the Müller–Lyer illusion in the Easy condition (r = .53, 95% CI [.46, .59]) exceeded r > .50. All other correlations fell below the threshold (Müller–Lyer Hard: r = .33, 95% CI [.23, .43]; Vertical–Horizontal Easy: r = .37, 95% CI [.29, .45]; Hard: r = .40, 95% CI [.32, .48]).

Overall, because the preregistered criterion (r > .50) was not consistently met across illusion types, outcomes, and difficulty levels, the Mild and Strong conditions were not collapsed and were analysed separately.
