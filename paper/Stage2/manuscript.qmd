...
# insight::export_table(table,
#                       column_names = c(
#                         "Illusion",
#                         "ER - Congruent", "ER - Mild", "ER - Strong",
#                         "IES - Congruent", "IES - Mild", "IES - Strong"))
```
...
<!-- #   flextable::theme_apa() -->
<!-- # -->
<!-- # insight::export_table(table, format = "tt", -->
<!-- #                       column_names = c("Congruent", "Mild", "Strong"), -->
<!-- readRDS("../../analysis/figures/table1.rds") |>  -->
<!--   gt::as_latex() -->
<!-- ``` -->
