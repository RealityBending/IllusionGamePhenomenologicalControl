...
p_pcs <- ggplot(df_r_pcs, aes(x = rho, y = Illusion, color = Condition)) +
  geom_point(position = position_dodge(width = 0.5)) +
  geom_errorbar(aes(xmin = CI_low, xmax = CI_high), position = position_dodge(width = 0.5), height = 0.2) +
...
p_psy<-  ggplot(df_r_psy, aes(x = rho, y = Illusion, color = Condition)) +
  geom_point(position = position_dodge(width = 0.5)) +
...
patchwork::wrap_plots(p_pcs + p_psy, guides="collect")
