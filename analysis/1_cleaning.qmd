...
data_ppt <- read.csv("C:/Users/olive/Documents/IllusionGamePCS/Data/rawdata_participants.csv")

data_ig <- read.csv("C:/Users/olive/Documents/IllusionGamePCS/Data/rawdata_illusion.csv") |>
    mutate(
...
The final sample includes `r report::report_participants(data_ppt, age="Age", sex="Sex", education="Education")`, for a total trial number of `r nrow(df)`.
...
```{r}
p_edu <- data_ppt |>
    mutate(Education = fct_relevel(Education, "Other", "Elementary school", "High school", "Bachelor", "Master", "Doctorate")) |> # Other value needs fixing due to custom responses
...
write.csv(data_ppt, "C:/Users/olive/Documents/IllusionGamePCS/Data/data_participants.csv", row.names = FALSE)
write.csv(data_ig, "C:/Users/olive/Documents/IllusionGamePCS/Data/data_illusion.csv", row.names = FALSE)
```
