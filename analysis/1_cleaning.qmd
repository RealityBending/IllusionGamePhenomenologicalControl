...
data_ig <- read.csv("C:/Users/asf25/Desktop/studies/IllusionGamePhenomenologicalControl/data/rawdata_illusion.csv")|> 
  group_by(Illusion_Type) |> 
  mutate(Illusion_Effect = ifelse(sign(Illusion_Strength) > 0, "Incongruent", "Congruent"),
         Task_Difficulty = abs(Illusion_Difference),
         Condition_Illusion = datawizard::categorize(
...
pcs$pcs_tastescore <- rowMeans(pcs[grepl("taste", names(pcs))])

pcs$pcs_postsessionsuggetsion <- sqrt(data_ppt$pcs_urgepress * data_ppt$pcs_memorypress)
